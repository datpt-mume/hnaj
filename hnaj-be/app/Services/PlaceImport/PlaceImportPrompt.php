    ...
    public function build(array $records, array $taxonomy): string
    {
        return json_encode([
            ...
            'rules' => [
                ...
                'When classification is invalid or uncertain, set error=true, explain briefly in error_reason, set normalized_address, category_id, district_id, min_price_vnd, and max_price_vnd to null, and return empty tag_ids and opening_hours arrays.',
