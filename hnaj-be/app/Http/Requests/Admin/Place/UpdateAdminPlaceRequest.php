...
class UpdateAdminPlaceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'images.*.id' => ['nullable', 'integer', 'exists:place_images,id'],
            'images.*.image_url' => ['required', 'string', 'max:2048', 'url'],
            'images.*.alt_text' => ['nullable', 'string', 'max:255'],
            'thumbnail_image_id' => ['nullable', 'integer', 'exists:place_images,id'],
            'deleted_image_ids' => ['nullable', 'array', 'max:20'],
            'deleted_image_ids.*' => ['integer', 'exists:place_images,id'],
        ];
    }
